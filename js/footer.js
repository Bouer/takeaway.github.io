document.getElementById("footer-byterbar").innerHTML=
`
<section class="d-none d-sm-block bg-warning">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-4 py-4" id="footerescribinos">
                <div class="row">
                    ...
                    <div class="col-8">
                        <p class="mb-0">Escribinos a: </p>
                        <div class="col-8 py-2">
                            <span class="pt-1"><i class="far fa-envelope"></i></span>
                            <a href="" title="" > info@bytebar.io</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-4 py-4">
                <div class="col-md-12 escribinos pb-1">
                    <span class="escribinos">Seguinos en:</span>
                </div>
